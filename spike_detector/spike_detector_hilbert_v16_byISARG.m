...
%--------------------------------------------------------------------------
if noverlap<1
    index=1:round(winsize*(1-noverlap)):size(d,1)-winsize+1; % indexy zaèátk? oken
else
...
if exist('parfor')==33 % If you don't have "Parallel Computing Toolbox", only standard for-cycle will be performed
